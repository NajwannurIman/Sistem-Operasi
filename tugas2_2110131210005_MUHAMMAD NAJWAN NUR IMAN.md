<h1><center>MODERN OPERATING SYSTEM</CENTER></H1>
...
tems work.  
<br>
<center><img src=foto1.1.png></center>
<center><b>Figure 1-1.</b> Where the operating system fits in.</center><br>
...
<u>to an extreme,</u> and pieces of what is traditionally considered to be the operating
† ‘‘He’’ should be read as ‘‘he or she’’ throughout the book.
<br>
<br><br>
<h2>SEC 1.1   &emsp; &emsp; &emsp;     WHAT AN OPERATING SYSTEM</h2>
...
when we study Windows in detail in Chap. 11.<br>
...
and look at Linux in detail in Chap. 10.<br>
...
<br><br>
<br>
<h1><b>1.1 WHAT AN OPERATING SYSTEM?</b></h1>
...
problem is that operating systems perform two essentially unrelated functions:  <br>
roviding application programmers (and application programs, naturally) a clean
...
<h2><b>1.1.1 The Operating System as an Extended  Machine</b></h2>
The <b>architecture</b> (instruction set, memory organization, I/O, and bus struc-
...
modern <b>SATA (Serial ATA)</b> hard disks used on most computers. A book (Ander-
...
ware level. Instead, a piece of software, called a <b>disk driver</b>, deals with the hard-
ware and provides an interface to read and write disk blocks, without getting into
the details. Operating systems contain many drivers for controlling I/O devices.<br>
...
deal with the messy details of how the hardware actually works<br>
...
abstractions. They are one of the keys to understanding operating systems.<br>
...
stead. Operating systems turn the ugly into the beautiful, as shown in Fig. 1-2.<br>
<center><img src=foto1.2.png></center>
<b>Figure 1-2.</b>Operating systems turn ugly hardware into beautiful abstractions.<br>
...
subject, but one only peripherally related to operating systems.<br><br>
    <h2><b>1.1.2 The Operating System as a Resource Manager</b></h2>
...
computer all tried to print their output simultaneously on the same printer. The first<br>
...
for usage, and to mediate conflicting requests from different programs and users.<br>
Resource management includes <b>multiplexing</b> (sharing) resources in two dif-
...
about which one is to be printed next.<br>
...
track of who is using which disk blocks is a typical operating system task.<br>
<br><br>
<br>
<h1><b>1.2 HISTORY OF OPERATING SYSTEM</b></h1>
...
historically been closely tied to the architecture of the computers on which they<br>
...
programmer. The programming language Ada® is named after her.<br>
<br>
<br>
<h2><b>1.2.1 The First Generation (1945-55):Vacuum Tubes</b></h2>
...
uum tubes would burn out during the run. Virtually all the problems were simple<br>
...
instead of using plugboards; otherwise, the procedure was the same.<br>
<br>

<h2><b>1.2.2 The Second Generation (1955-65):Transitor ans Batch System </b></h2>
...
sonnel.<br>
These machines, now called <b>mainframes</b>, were locked away in large, specially
...
around the machine room.<br>
iven the high cost of the equipment, it is not surprising that people quickly
...
real computing. This situation is shown in Fig. 1-3.<br>
...
operating system automatically read the next job from the tape and began running<br>
<center><img src=foto1.3.png></center>
...
1401 for printing <b>off line</b> (i.e., not connected to the main computer)<br>
...
System) and IBSYS, IBM’s operating system for the 7094.<br>
<h2><b>1.2.2 The Second Third (1965-1980):IC and Multiprograming</b></h2>
...
merical calculations in science and engineering. On the other hand, there were the<br>
<center><img src=foto1.4.png></center>
character-oriented, commercial computers, such as the 1401, which were widely
used for tape sorting and printing by banks and insurance companies.<br>
...
machine that would run all their old programs, but faster.<br>
...
the original.<br>
The IBM 360 was the first major computer line to use (small-scale) <b>ICs (Inte-
grated Circuits)</b>, thus providing a major price/performance advantage over the
second-generation machines, which were built up from individual transistors. It<br>
...
World Wide Web sites that must process thousands of requests per second.<br>
...
ments. Above all, it had to be efficient for all of these different uses.<br>
...
ones, so the number of bugs probably remained constant over time.<br>
...
(2012) makes a similar point about operating systems being dinosaurs.<br>
...
done to avoid having the (expensive) CPU be idle so much.<br>
...
third-generation systems were equipped with this hardware<br>
<center><img src=foto1.5.png></center>
...
que is called <b>spooling</b> (from <>Simultaneous Peripheral Operation On Line) and
was also used for output. With spooling, the 1401s were no longer needed, and
much carrying of tapes disappeared.<vr>
...
grammers did not like that very much.<br>
...
first general-purpose timesharing system,<b> CTSS (Compatible Time Sharing Sys-
tem)</b>, was developed at M.I.T. on a specially modified 7094 (Corbato ́ et al., 1962).
However, timesharing did not really become popular until the necessary protection
hardware became widespread during the third generation<br>
...
†We will use the terms ‘‘procedure,’’ ‘‘subroutine,’’ and ‘‘function’’ interchangeably in this book<br>
...
fiction. Sort of like the idea of supersonic trans-Atlantic undersea trains now<br>
...
time, much like Charles Babbage’s analytical engine in the nineteenth century.<br>
...
after years of trying to get Honeywell to update the hardware.<br>
...
the spirit of the MULTICS design.<br>
...
in the academic world, with government agencies, and with many companies.<br>
...
fact, some other operating systems now also support the POSIX interface<br>
...
able for free (including all the source code) over the Internet at www.minix3.org.<br>
...
versions and clones of UNIX as well.<br>
<br>
<h2><b>1.2.4 The Fourth Generation (1980-Present):Personal Computers</b></h2>
With the development of <b>LSI (Large Scale Integration) </b>circuits—chips con-
...
to have his or her own personal computer.<br>
...
nate the world of microcomputing for about 5 years.<br>
...
Gates asking if he could provide them with an operating system<br>
When IBM came back, Gates realized that a local computer manufacturer,
Seattle Computer Products, had a suitable operating system, <b>DOS (Disk Operat-
ing System)</b>. He approached them and asked to buy it (allegedly for $75,000),
...
and incorporated into machines they built.<br>
...
OS X is a UNIX-based operating system, albeit with a very distinctive interface.<br>
...
dows 98 still contained a large amount of 16-bit Intel assembly language.<br>
Another Microsoft operating system, <b>Windows NT</b> (where the NT stands for
<b>New Technology</b>), which was compatible with Windows 95 at a certain level, but a complete rewrite from scratch internally. It was a full 32-bit system. The lead de-
...
ating systems textbooks) balmy.<br>
...
also often present on desktop computers, notebooks, tablets, and smartphones. Onx86-based computers, Linux is becoming a popular alternative to Windows for stu-
...
x86-32 and x86-64 to indicate 32-bit and 64-bit variants.FreeBSD is also a popular UNIX derivative, originating from the BSD project
...
ficiently by the operating system.<br>
True distributed operating systems require more than just adding a little code
to a uniprocessor operating system, because distributed and centralized systems differ in certain critical ways. Distributed systems, for example, often allow appli-
cations to run on several processors at the same time, thus requiring more complex
processor scheduling algorithms in order to optimize the amount of parallelism.<br>
...
ating system has complete information about the system state.<br>
<br>
<h2><b>1.2.4 The Fifth Generation (1990-Present):Mobile Computers</b></h2>
...
you had a car in which to carry it.<br>
...
Ericsson coined the term smartphone for its GS88 ‘‘Penelope.’’<br>
...
phones, it is that it is not easy to stay king of the mountain for long.<br>
...
dows Phone as its primary platform. For some time, Apple and RIM were the toast of the town (although not nearly as dominant as Symbian had been), but it did not
take very long for Android, a Linux-based operating system released by Google in
2008, to overtake all its rivals.<br>
...
<br>
<h1><b>1.5 OPERATING SYSTEM CONCEPTS</b></h1>
<br>
...
following sections, we will look at some of these basic concepts ever so briefly, as<br>
...
however, and we will study some of them later.<br>
<br>
<h4><b>1.5.1 Processes</b></h4>
<br>
...
run the program. A process is fundamentally a container that holds all the information needed to run a program.<br>
...
used up more than its share of CPU time in the past second or two.<br>
We will come back to the process concept in much more detail in Chap. 2. For
the time being, the easiest way to get a good intuitive feel for a process is to think
about a multiprogramming system. The user may have started a video editing program and instructed it to convert a one-hour video to a certain format (something
that can take hours) and then gone off to surf the Web. Meanwhile, a background
...
items needed to restart the process later.<br>
...
command interpreter or shell reads commands from a terminal. The user has just<br>
...
compilation, it executes a system call to terminate itself.<br>
...
will be addressed in detail in Chap. 2.<br>
<br>
<img src=foto1.13.PNG align="center">
<br>
...
the program may continue doing other work.<br>
...
an invalid address, are also converted into signals to the guilty process.<br>
...
who started it. A child process has the same UID as its parent. Users can be members of groups, each of which has a GID (Group IDentification).<br>
...
password.
We will study processes and interprocess communication in Chap. 2.<br>
<br>
<h4><b>1.5.2 Address Spaces</b></h4>
<br>
...
operating system), some kind of protection mechanism is needed. While this mechanism has to be in the hardware, it is controlled by the operating system.<br>
...
enough room in main memory to hold it all.<br>
...
system does, so all of Chap. 3 is devoted to this topic.<br>
...
closed, so calls are provided to do these things.<br>
...
Fig. 1-14.<br>
<br>
<center><img src=foto1.14.PNG></center>
<br>
...
differ for processes and files. Typically, only a parent process may control or even<br>
access a child process, but mechanisms nearly always exist to allow files and directories to be read by a wider group than just the owner.<br>
...
the UNIX convention for paths.<br>
...
change their working directory by issuing a system call specifying the new working directory<br>
...
call, the root file system, on the hard disk, and a second file system, on a CDROM, are separate and unrel<br>
...
they can all be mounted into a single tree as well<br>
<br>
<img src=foto1.15.PNG align="center">
<br>
...
have much more to say about them in Chap. 4 and also in Chaps. 10 and 11.<br>
<br>
<img src= foto1.16.PNG>
<br>
<hr>
<h4><b>1.5.4 Input/Output</b></h4>
...
up to the operating system to manage these devices.<br>
...
specific to particular I/O devices. In Chap. 5 we will have a look at I/O software.<br>
<br>
<hr>
<h4><b>1.5.5 Protection</b></h4>
<br>
...
returns, and much more. It is up to the operating system to manage the system security so that files, for example, are accessible only to authorized users.<br>
...
directory, x indicates search permission. A dash means that the corresponding permission is absent<br>
...
one of them. We will look at various security issues in Chap. 9.<br>
<br>
<hr>
<h4><b>1.5.6 The Shell</b></h4>
...
All of them support the functionality described below, which derives from the original shell (sh).<br>
...
such as a dollar sign, which tells the user that the shell is waiting to accept a command. If the user no<br>
<br>
date
<br>
...
line.<br>
The user can specify that standard output be redirected to a file, for example,<br>
<br>
date >file
<br>
<br>
Similarly, standard input can be redirected, as in<br>
<br>
sort < file1 >file2
<br>
...
connecting them with a pipe. Thus<br>
<br>
cat file1 file2 file3 | sort >/dev/l
<br>
invokes the cat program to concatenate three files and send the output to sort to
arrange all the lines in alphabetical order. The output of sort is redirected to the file<br>
/dev/lp, typically the printer.
If a user puts an ampersand after a command, the shell does not wait for it to
complete. Instead it just gives a prompt immediately. Consequently,<br>
<br>
...
program by changing some values in the registry, although few people do this.<br>
<br><hr>
<h4><b>1.5.7 Ontogeny Recapitulates Phylogeny</b></h4>
<br>
...
it still has a kernel of truth in it<br>
...
but in computer science, it is sometimes only for a few years.<br>
...
concept is obsolete and what changes in the environment might bring it back again.<br>
...
was faster. Now we are seeing the resurgence of interpretation in the form of Java is not always crucial because network delays are so great that they tend to dominate. Thus the pendulum has already swung several cycles between direct execution and interpretation and may yet swing again in the future <br>
<br>
<b>Large Memories</b>
<br>
<br>
...
compiled to the smart card’s machine language.<br>
<br>
...
running (multiprogramming). Monoprogramming was declared obsolete.<br>
...
had no protection hardware, eventually the PDP-11 did, and this feature led to multiprogramming and eventually to UNIX.<br>
...
embedded systems have no protection hardware and run just a single program.<br>
...
once, and then full timesharing capabilities.<br>
...
in the computer industry it seems to spin faster<br>
<br>
<b>Disk</b>
<br>
...
decided that, say, ‘‘data’’ was a suitable name for a file. This was a single-level directory. Eventually, mainframes developed complex hierarchical file systems, perhaps culminating in the MULTICS file system.<br>
...
When microcomputers came out, CP/M was initially the dominant operating system, and it, too, supported just one directory on the (floppy) disk.<br>
<br>
<b>Virtual Memory</b>
<br>
...
come back on embedded computers and smart cards.<br>
<HR>


<h1>1.6 SYSTEM CALLS</h1>
...
<p align="center"><img src=foto1.17.PNG>
...
<p align="center"><img src =foto1.18.PNG>
...
<p align="center"><img src=foto1.19.PNG>
...
<p align="center"><img src=foto1.20.PNG>
...
<p align="center"><img src=foto1.21.PNG>
...
<p align="center"><img src=foto1.22.PNG>
...
<p align="center"><img src=foto1.23.PNG>
...
<p align="center"><img src=foto1.24.PNG>
...
<p align="center"><img src=foto1.25.PNG>
...
<p align="center"><img src=foto1.26.PNG>
...
<p align="center"><img src=foto1.27.PNG>
...
<p align="center"><img src=foto1.28.PNG>
...
<p align="center"><img src=foto1.29.PNG>
...
<p align="center"><img src=foto1.30.PNG>
...
Chapter 6 is about deadlocks. We briefly showed what deadlocks are in this chapter, but there is much more to say. Ways to prevent or avoid them are dis- cussed.
...
<p align="center"><img src=foto1.31.PNG>
...
<p align="justify">1. What are the two main functions of an operating system?
...
Examine and try to interpret the contents of a UNIX-like or Windows directory with a tool like the UNIX od program. (Hint: How you do this will depend upon what the OS allows. One trick that may work is to create a directory on a USB stick with one oper- ating system and then read the raw device data using a different operating system that allows such access.)</p>
